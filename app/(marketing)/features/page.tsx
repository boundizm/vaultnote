  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <header className="sticky top-0 z-50 w-full border-b border-border/40 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="mx-auto flex h-14 max-w-screen-xl items-center justify-between px-6">
          ...
          <nav className="hidden items-center space-x-6 text-sm font-medium md:flex">
            ...
            <Link href="/features" className="transition-colors hover:text-foreground text-foreground">
              Features
            </Link>
        ...
        <div className="mx-auto max-w-screen-xl px-6">
          <div className="text-center">
            ...
            <p className="mx-auto mb-12 max-w-xl text-lg text-muted-foreground sm:text-xl leading-relaxed">
              Discover all the advanced features that make VaultNote the most secure note-taking solution available.
            </p>
      ...
      <section className="px-6 py-16 sm:py-32 sm:px-8">
        <div className="mx-auto max-w-screen-xl w-full py-12 xs:py-20 px-6">
          <motion.div variants={fadeUp}>
            <h2 className="mb-6 text-3xl font-bold tracking-tight sm:text-4xl">
              Ready to experience all features?
            </h2>
            <p className="mb-12 text-xl text-muted-foreground leading-relaxed">
              Start creating secure, self-destructing notes with all advanced features. No registration required.
            </p>
            <Button asChild size="lg" className="h-12 px-8 text-base">
              <Link href="/create">
                <Lock className="mr-2 h-5 w-5" />
