...
import { Shield, Lock, ArrowRight, Menu, X, Clock, MapPin, Key, Eye, Database } from 'lucide-react';
...
const securityFeatures = [
  {
    ...
    description:
      "Military-grade AES-256-GCM encryption protects your notes from the moment you create them. The same standard used by governments and banks worldwide.",
  },
  {
    icon: Lock,
    title: "Zero-Knowledge Architecture",
    description:
      "We cannot read your notes. The encryption keys exist only in your browser. Even if our servers are compromised, your data remains secure.",
  },
  {
    icon: Key,
    title: "Client-Side Encryption",
    description:
      "All encryption happens in your browser before any data leaves your device. Your notes are encrypted locally using the Web Crypto API.",
  },
  {
    icon: Eye,
    title: "No Data Collection",
    description:
      "We don't track users, collect analytics, or store any metadata. No IP addresses, timestamps, or usage data is retained.",
  },
  {
    icon: Database,
    title: "Secure Storage",
    description:
      "Encrypted notes are stored on Swiss servers with bank-level security. We use encrypted databases and regular security audits.",
  },
  {
    icon: MapPin,
    title: "Swiss Privacy Laws",
    description:
      "Hosted in Switzerland with the world's strongest data protection laws. No US Cloud Act, no government backdoors.",
  },
];
  ...
  return (
    <div className="py-32 bg-muted/5 dark:bg-muted/10">
      <div className="max-w-screen-xl mx-auto w-full py-12 xs:py-20 px-6">
        <h2 className="text-4xl md:text-5xl font-bold tracking-tight sm:max-w-xl text-pretty sm:mx-auto sm:text-center mb-6">
          Security at Every Layer
        </h2>
        <p className="text-muted-foreground text-lg sm:text-xl sm:text-center mb-12">
          Built with security-first principles and military-grade encryption standards.
        </p>
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <header className="sticky top-0 z-50 w-full border-b border-border/40 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="mx-auto flex h-14 max-w-screen-xl items-center justify-between px-6">
          ...
          <nav className="hidden items-center space-x-6 text-sm font-medium md:flex">
            ...
            <Link href="/security" className="transition-colors hover:text-foreground text-foreground">
              Security
            </Link>
        ...
        <div className="mx-auto max-w-screen-xl px-6">
          <div className="text-center">
            <div className="mb-8 inline-flex items-center rounded-full border border-border bg-card/50 px-4 py-2">
              ...
              <span className="text-sm font-medium">Technical Security</span>
            </div>

            <h1 className="mb-8 text-4xl font-bold tracking-tight text-foreground sm:text-5xl lg:text-6xl">
              <span className="block">Security that you can</span>
            ...
            <p className="mx-auto mb-12 max-w-xl text-lg text-muted-foreground sm:text-xl leading-relaxed">
              Every aspect of VaultNote is designed with security in mind. From encryption to storage, we prioritize your privacy above everything else.
            </p>
      ...
      <section className="px-6 py-16 sm:py-32 sm:px-8">
        <div className="mx-auto max-w-screen-xl py-12 xs:py-20 px-6">
          <motion.div variants={fadeUp}>
            <h2 className="mb-6 text-3xl font-bold tracking-tight sm:text-4xl">
              Ready to experience true security?
            </h2>
            <p className="mb-12 text-xl text-muted-foreground leading-relaxed">
              Join thousands of users who trust VaultNote for their most sensitive communications. No registration required.
            </p>
            <Button asChild size="lg" className="h-12 px-8 text-base">
              <Link href="/create">
                <Lock className="mr-2 h-5 w-5" />
