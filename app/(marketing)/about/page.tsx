...
import { Shield, Lock, ArrowRight, Menu, X, Users, Code, Heart, Target } from 'lucide-react';
...
const teamMembers = [
  {
    ...
    description: "VaultNote is built by a passionate community of security experts and developers committed to privacy.",
    icon: Users,
  },
  {
    name: "Privacy First",
    role: "Core Mission",
    description: "We believe privacy is a fundamental human right. VaultNote exists to protect your digital communications.",
    icon: Shield,
  },
  {
    name: "Modern Web Tech",
    role: "Built with Care",
    description: "Using cutting-edge web technologies like Web Crypto API, React, and Next.js for optimal security and performance.",
    icon: Code,
  },
  {
    name: "User-Centric",
    role: "Designed for You",
    description: "Every feature is designed with the user in mind - simple, secure, and powerful.",
    icon: Heart,
  },
];
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            <h2 className="text-3xl md:text-4xl font-bold tracking-tight mb-6">
              Why VaultNote Exists
            </h2>
            <div className="space-y-6 text-lg text-muted-foreground">
              <p>
                In a world where privacy is increasingly under threat, we created VaultNote to give people back control over their digital communications.
              </p>
              <p>
                Traditional messaging apps collect metadata, track your behavior, and store your conversations indefinitely. VaultNote takes a different approach - zero-knowledge encryption, automatic deletion, and no data collection.
              </p>
              <p>
                We're building the future of secure communication, one encrypted note at a time.
              </p>
            </div>
          </div>
      ...
      <header className="sticky top-0 z-50 w-full border-b border-border/40 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="mx-auto flex h-14 max-w-screen-xl items-center justify-between px-6">
          ...
          <nav className="hidden items-center space-x-6 text-sm font-medium md:flex">
            ...
            <Link href="/about" className="transition-colors hover:text-foreground text-foreground">
              About
            </Link>
          </nav>
        ...
        <div className="mx-auto max-w-screen-xl px-6">
          <div className="text-center">
            ...
            <p className="mx-auto mb-12 max-w-xl text-lg text-muted-foreground sm:text-xl leading-relaxed">
              VaultNote is more than just an app - it's a movement towards privacy-first digital communication. Open source, community-driven, and built for the future.
            </p>
        ...
        <div className="mx-auto max-w-screen-xl py-12 xs:py-20 px-6">
          <motion.div variants={fadeUp}>
            <h2 className="mb-6 text-3xl font-bold tracking-tight sm:text-4xl">
              Ready to contribute to privacy?
            </h2>
            <p className="mb-12 text-xl text-muted-foreground leading-relaxed">
              VaultNote is open source and community-driven. Join us in building the future of secure digital communication.
            </p>
